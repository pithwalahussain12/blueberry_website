            ...
            <div className='container' style={{ borderBottom: '1px solid #000000', paddingBottom: '3rem' }}>
                <div className='lg:grid block grid-cols-2 gap'>
                    <div className='flex items-center'>
                        <div>
                            <h2 className='lg:text-[6vw] lg:leading-[6vw] productBold mb-8'>Let’s <br />
                                Transform<br />
                                Your Brand
                            </h2>
                            <p className='text-[1vw] lg:w-[26vw] productregular pb-6'>Looking for a brand partner in a new way?</p>
                            <p className='text-[1vw] lg:w-[26vw] productregular pb-6'>
                    ...
                    <div>
                        <video loop autoPlay muted className='h-full  p-20 pr-0 rounded-[4vw] w-full'>
